...
{	
	...
	public class CharacterWallClinging : CharacterAbility 
	{
		...
		[SerializeField]
		private LayerMask wallClingingMask;
		...
		{
            if (_controller.CurrentWallCollider == null || _controller.CurrentWallCollider.layer != LayerMask.NameToLayer("ClingingPlatform"))
            {
                return;
            }
